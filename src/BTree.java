...
public class BTree<T extends Comparable<T>> {
    ...
    public static void main(String[] args) {
        ...
        generatedTree.insert(100);
        generatedTree.insert(120);
        generatedTree.insert(130);
        generatedTree.insert(140);
        generatedTree.insert(150);
        generatedTree.insert(160);
        generatedTree.insert(170);
        generatedTree.insert(180);
        generatedTree.insert(190);
        generatedTree.remove(130);
